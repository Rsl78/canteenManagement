    ...
    return (
        <div className={"min-h-85 min-w-70 bg-white  rounded-lg shadow-lg p-4 flex flex-col items-center justify-center "}>
            ...
            <div className="flex flex-col">
                <h3 className="text-lg font-semibold">Delicious Food</h3>
                <p className="text-sm text-gray-600">This is a description of the food item.</p>

                <div className={"flex justify-between pt-3"}>
                    <div className={"  flex justify-center  items-center  "}>
                        <p className="flex items-center text-gray-600 font-semibold text-lg align-middle"> <span><img className={"h-5 w-5"} src={takaIcon} alt="arrow"/></span> 200</p>
                    </div>
                    <button className="btn bg-dark-emerald text-white  rounded-full items-center py-0.5 mt-1">
